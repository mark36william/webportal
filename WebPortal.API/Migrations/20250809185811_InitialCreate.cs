    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecentlyViewedProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecentlyViewedProperties_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecentlyViewedProperties_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecentlyViewedProperties_PropertyId",
                table: "RecentlyViewedProperties",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_RecentlyViewedProperties_UserId_PropertyId",
                table: "RecentlyViewedProperties",
                columns: new[] { "UserId", "PropertyId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RecentlyViewedProperties_ViewedAt",
                table: "RecentlyViewedProperties",
                column: "ViewedAt");
        }
